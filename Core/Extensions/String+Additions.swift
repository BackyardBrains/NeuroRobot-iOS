...
extension String {
    ...
    func getPointer() -> UnsafeMutablePointer<Int8>? {
    ...
    func splitInReverseWithFirstOccuranceOf(separator string: String) -> [String]? {
        if let theRange = range(of: string, options: .backwards) {
            return [String(self[..<theRange.lowerBound]), String(self[theRange.lowerBound...])]
        } else {
            return nil
        }
    }
